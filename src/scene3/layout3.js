...
export const YEARS = [
  {
    year: 2021,
    key: 'The Spark',
    lines: ['Started BCA', 'Wrote first code', 'Found my passion'],
  },
  {
    year: 2022,
    key: 'Building',
    lines: ['Learned C++, Java', 'First web projects', 'Kept going'],
  },
  {
    year: 2023,
    key: 'Deep Dive',
    lines: ['Full-stack projects', 'React & Python', 'Real solutions'],
  },
  {
    year: 2024,
    key: 'Graduation',
    lines: ['BCA completed', 'Portfolio built', 'Ready to ship'],
  },
  {
    year: 2025,
    key: 'Iclonis Tech',
    lines: ['Joined the team', 'Junior Engineer', 'Solving real problems'],
  },
  {
    year: 2026,
    key: 'Now & Next',
    lines: ['Growing fast', 'Shipping features', 'Building the future'],
  },
];
