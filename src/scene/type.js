// Renders ABHISHEK into a single coverage texture and reports the ink rectangle
// of every individual letter.
//
// Why a texture and not DOM text: the two people who live inside the A and the K
...
// measured and adjusted for ABHISHEK (8 letters vs 6): ink width / cap height
export const TARGET_RATIO = 4.16;
